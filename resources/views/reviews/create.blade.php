            ...
            <section class="content">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputStatus" class="form-control custom-select">
                                        ...
                                        <option>Foreign literature</option>
                                        <option>Viet Nam literature</option>
                                    </select>
                                </div>
                                <div class="form-group">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form method="GET" action="{{ route('review.post.create') }}">
                            <input type="submit" value="Create new review" class="btn btn-success float-right">
                        </form>
                    </div>
                </div>
            </section>
